...
// Socket.IO setup (used from Day 3 onwards for real-time dashboard)
...
const startServer = async () => {
  ...
  httpServer.listen(PORT, () => {
    ...
    console.log('â•‘         ðŸ«€ RecoverPulse AI Server            â•‘');
    console.log('â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•£');
    console.log(`â•‘  ðŸŒ HTTP:   http://localhost:${PORT}             â•‘`);
    console.log(`â•‘  ðŸ”Œ WS:     Socket.IO ready                  â•‘`);
    console.log(`â•‘  ðŸ“Š Health: http://localhost:${PORT}/api/health   â•‘`);
    console.log(`â•‘  ðŸ—ï¸  Mode:   ${process.env.NODE_ENV || 'development'}                    â•‘`);
